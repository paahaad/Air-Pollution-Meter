...
#define co2Zero     85                        //calibrated CO2 0 level
...
//                                                LIBRARY CALL
//---------------------------------------------------------------------------------------------------------------
Adafruit_SH1106 display(OLED_RESET);         //create instance of OLED called display
...
void setup() {
  ...
  display.begin(SH1106_SWITCHCAPVCC, 0x3C);  //begin display @ hex addy 0x3C
...
for (int x = 0;x<10;x++){                     //add samples together
  ...
  co2ppm = map(co2comp,0,1023,200,3000);      //map value for atmospheric levels
